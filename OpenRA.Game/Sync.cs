...
namespace OpenRA
{
	...
	/// Tag members that need to be synced with <see cref="VerifySyncAttribute"/>.
	/// </summary>
	...
	/// which will cause an implementation to be automatically generated using all type members that have the <see cref="VerifySyncAttribute"/>.
	/// </summary>
