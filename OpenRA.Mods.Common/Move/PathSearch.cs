...
namespace OpenRA.Mods.Common.Move
{
	public sealed class PathSearch : IDisposable
	{
		...
		public PathSearch (OpenRA.World world, MobileInfo mobileInfo, Actor self)
		{
			this.self = self;
		...
		public static PathSearch Search (OpenRA.World world, MobileInfo mi, Actor self, bool checkForBlocked)
		{
		...
		public static PathSearch FromPoint (OpenRA.World world, MobileInfo mi, Actor self, CPos from, CPos target, bool checkForBlocked)
		{
			var search = new PathSearch(world, mi, self)
			{
		...
		public static PathSearch FromPoints (OpenRA.World world, MobileInfo mi, Actor self, IEnumerable<CPos> froms, CPos target, bool checkForBlocked)
		{
			var search = new PathSearch(world, mi, self)
			{
				Heuristic = DefaultEstimator(target),
		...
		public CPos Expand (OpenRA.World world)
		{
			var p = Queue.Pop();
