...
namespace OpenRA.Mods.Common.Orders
{
	public class PlaceBuildingOrderGenerator : IOrderGenerator
	{
		...
		IEnumerable<Order> InnerOrder(World world, CPos xy, MouseInput mi)
		{
			...
			{
				var topLeft = xy - BuildingFootprintUtils.AdjustForBuildingSize(BuildingInfo);
		...
		public IEnumerable<IRenderable> RenderAfterWorld(WorldRenderer wr, World world)
		{
			...
			else
			{
				...
				var offset = world.Map.CenterOfCell(topLeft) + BuildingFootprintUtils.CenterOffset(world, BuildingInfo);
				...
				foreach (var t in BuildingFootprintUtils.Tiles(rules, Building, BuildingInfo, topLeft))
