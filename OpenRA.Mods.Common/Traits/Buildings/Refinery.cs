...
namespace OpenRA.Mods.Common.Traits.Buildings
{
	...
	public class Refinery : ITick, IRefinery, INotifyKilled, INotifySold, INotifyCapture, IExplodeModifier, ISync
	{
		readonly Actor self;
		...
		public virtual Activity DockSequence (Actor harv, Actor self) { throw new NotImplementedException(); }
