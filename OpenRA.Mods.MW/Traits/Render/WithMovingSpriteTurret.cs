...
namespace OpenRA.Mods.MW.Traits
{
	...
	public class WithMovingSpriteTurretInfo : UpgradableTraitInfo, IRenderActorPreviewSpritesInfo,
		Requires<RenderSpritesInfo>, Requires<TurretedInfo>, Requires<BodyOrientationInfo>, Requires<ArmamentInfo>
	{
		...
		[SequenceReference] public readonly string MoveSequence = "turret";
	...
	public class WithMovingSpriteTurret : UpgradableTrait<WithMovingSpriteTurretInfo>, INotifyBuildComplete, INotifySold, INotifyTransform, ITick, INotifyDamageStateChanged
	{
