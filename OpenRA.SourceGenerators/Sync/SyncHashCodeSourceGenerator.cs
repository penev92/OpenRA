...
//		(string FileName, string Content) GenerateClass(NameSyntax namespaceName, string className, IEnumerable<string> syncMembersAsHashCodeStrings, bool isSealed, bool syncsTargets)
//		{
